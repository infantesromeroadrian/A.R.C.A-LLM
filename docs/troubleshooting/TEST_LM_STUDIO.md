...
```
✓ Modelo cargado en memoria: qwen/qwen3-8b
✓ Contexto disponible
...
Si qwen3-8b no funciona, prueba con:
...
| mistral-7b | ~4GB | Rápido | Buen balance |
| qwen2.5-7b | ~4GB | Rápido | Multilingüe |
