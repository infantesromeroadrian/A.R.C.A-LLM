/* ===== CHAT DORADO DE CONVERSACIÓN TIPO KARAOKE ===== */
...
function inicializarChatDorado() {
    ...
    // Contenedor para historial (scrollable)
    ...
    contenedorScreen.addEventListener('click', (e) => {
        // Solo alternar si se hace click en el mensaje actual o en el contenedor vacío
        if (!e.target.closest('.gold-screen-message.message-historial')) {
            alternarExpansion();
        }
    });
    ...
    console.log('Chat dorado karaoke inicializado');
}
...
// Añadir mensaje al chat con comportamiento tipo karaoke
